...
const (
	UserService_CreateUser_FullMethodName = "/learngrpc.user.v1.UserService/CreateUser"
	UserService_GetUser_FullMethodName    = "/learngrpc.user.v1.UserService/GetUser"
	UserService_ListUsers_FullMethodName  = "/learngrpc.user.v1.UserService/ListUsers"
)
...
//
// UserService 用户服务。
// 演示：Unary RPC（CreateUser / GetUser）和 服务端流式 RPC（ListUsers）。
type UserServiceClient interface {
	// CreateUser 创建用户（Unary）
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*User, error)
	// GetUser 根据 id 获取用户（Unary）
	GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*User, error)
	// ListUsers 列出用户（Server streaming，服务端持续推流）
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "learngrpc.user.v1.UserService",
